        ...
        <div className="w-full md:w-1/2 h-full  flex flex-col">
            ...
            <form className="flex flex-col w-full h-[95%] pr-7  justify-evenly items-center"><br />
                ...
                <div className="w-3/4 h-14 flex gap-3"> 
                    <button className="bg-gray-300 w-3/4 p-3 text-lg font-semibold text-verde-principal rounded-full -mb-1 hover:bg-red-200 bt">Cancelar</button>
                    <button className="bg-verde-principal w-3/4 p-3 text-lg whitespace-nowrap font-semibold text-white rounded-full -mb-1 hover:bg-gray-200 hover:text-verde-principal bt">Iniciar sesión</button>
                </div>
                <button className="bg-gray-200 w-3/4 p-2 text-lg transition-opacity text-black rounded-full flex items-center gap-2"><img src="data:image/png;base64," />
