...
function Certificados() {
    return (
     ...
     <div className="flex flex-row gap-4 flex-col items-center pt-32 font-semibold">
      <button className="bg-Gris text-black font-bold py-2 px-4 rounded h-12 w-60">Generar Certificado</button>
      <button className="bg-Gris text-black font-bold py-2 px-4 rounded  h-12 w-60">Generar Informe</button>
